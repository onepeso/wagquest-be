...
func main() {
	...
	config.AllowOrigins = []string{"http://localhost:3000", "http://10.0.0.124:3000", "https://wagquest-fe.vercel.app/", "wagquest-94ktzww4j-onepeso-studio.vercel.app", "https://wagquest.com"} // Update this when deploying
